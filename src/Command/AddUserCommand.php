...
use Symfony\Component\Message\MessageBus;
...
class AddUserCommand extends Command
{
    ...
    public function __construct(MessageBusInterface $messageBus, UserPasswordEncoderInterface $encoder, Validator $validator, UserRepository $users)
    {
        parent::__construct();
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $command = new CreateNewUser($fullName, $username, $plainPassword,  $email, [$isAdmin ? 'ROLE_ADMIN' : 'ROLE_USER']);
